# The Party
> DM reference only. Players manage their own full character sheets.
> Update this after each session. Keep it lightweight.
...
## Languages
> Barovia has NPCs who speak Barovian (Common), some who speak only Elvish or Draconic.

| Character | Languages Known |
|-----------|----------------|
| | |
| | |
| | |
...
## Relationships & Bonds
> Track who the party has connected with. Useful for NPC callbacks.

| Character | Notable Bond | NPC / Detail |
|-----------|-------------|-------------|
| | | |
| | | |
| | | |
...
## Party Inventory (Shared / Notable Items)
> Individual consumables stay on player sheets. Track shared and significant items here.
...
## Artifact Checklist
- [ ] Tome of Strahd — Location: _______________ (Tarokka draw)
- [ ] Holy Symbol of Ravenkind — Location: _______________ (Tarokka draw)
- [ ] Sunsword hilt — Amber Temple (always)
- [ ] Sunsword *empowered* — After Sergei summoning
