# Physical Collection — Miniatures, Terrain & Structures
Track what you own, what you need, and what's suggested for each act of the campaign.

> **Legend:**
> - ✅ Own it
> - 🛒 On the list / ordered
> - ⬜ Suggested — don't have yet
> - ❌ Skipping
...
### Priority 1 — Core Campaign (Use Every Act)
...
### Priority 3 — Recurring Allies & Notable NPCs
...
### Priority 4 — Background / One-Scene NPCs

| Mini | NPC File | Own? | Proxy Option |
|------|---------|------|-------------|
| Gadof Blinsky | `others/vallaki_townspeople.md` | ⬜ | Any civilian male |
| Henrik van der Voort | `others/vallaki_townspeople.md` | ⬜ | Any civilian male |
...
| Mini | Notes | Own? |
|------|-------|------|
| Ludmilla Vilisevic | Robed vampire woman; analytical | ⬜ |
| Anastrasya Karelova | Elegant vampire in court dress | ⬜ |
| Sasha Ivliskova | Quiet, resigned vampire woman | ⬜ |
| Escher | Male vampire in fine clothes | ⬜ |

> File: `monsters/strahds_brides.md`

---

## Monster / Enemy Miniatures

### By Session

| Session | Monster(s) Needed | CR | Quantity | Own? |
|---------|-----------------|-----|----------|------|
| M1 W1 | Specter (Nursemaid) | 1 | 1 | ⬜ |
| M1 W1 | Ghosts (Rose & Thorn) | 4 | 2 | ⬜ |
| M1 W1 | Flesh Mound (Shambling Mound) | 5 | 1 | ⬜ |
| M1 W2 | Zombies | 1/4 | 6 | ⬜ |
| M1 W2 | Wolves | 1/4 | 4 | ⬜ |
| M1 W3 | Strix (bat-things) | 1/8 | 8 | ⬜ |
| M1 W4 | Vampire Spawn | 5 | 2 | ⬜ |
| M2 W1 | Vampire Spawn (Volenta's) | 5 | 3 | ⬜ |
| M2 W2 | Wolves / Dire Wolves | 1, 2 | 4 + 2 | ⬜ |
| M2 W3 | Izek Strazni | 6 | 1 | ⬜ |
| M2 W4 | Night Hags (coven) | 5 | 3 | ⬜ |
| M3 W1 | Druid Shamans | 2 | 6 | ⬜ |
| M3 W1 | Wintersplinter (Tree Blight) | 5 | 1 | ⬜ |
| M3 W2 | Werewolves | 3 | 8 | ⬜ |
| M3 W2 | Kiril Stoyanovich (alpha) | 7 | 1 | ⬜ |
| M3 W3 | Revenants | 5 | 4 | ⬜ |
| M3 W4 | Vampire Spawn (Ravenloft) | 5 | 8 | ⬜ |
| M4 W1 | Wolves (mountain) | 1/2 | 6 | ⬜ |
| M4 W2 | Amber Golem (Stone Golem proxy) | 18 | 1 | ⬜ |
| M4 W2 | Patrina Velikovna (wraith) | 5 | 1 | ⬜ |
| M4 W3 | Baba Lysaga | 11 | 1 | ⬜ |
| M4 W4 | Strahd von Zarovich (final) | 15+ | 1 | ⬜ |
| M4 W4 | Rahadin (if combat) | 15 | 1 | ⬜ |
| M4 W4 | Vampire Spawn (final battle swarm) | 5 | 6–8 | ⬜ |

---

## Terrain & Structures

### Priority 1 — Used Multiple Sessions

| Terrain / Structure | Sessions Used | Own? | Notes |
|--------------------|--------------|------|-------|
| **Castle Ravenloft** (modular or printed) | M3 W3 (dinner), M3 W4 (heist), M4 W4 (final) | ⬜ | Most important terrain in the campaign; 3D print or Dwarven Forge; even a 2D map suffices |
| **Dungeon/stone corridors** | M1 W1 (Death House basement), M3 W4 (Ravenloft dungeons) | ⬜ | Standard dungeon tiles work; reuse for both |
| **Tavern interior** | M1 W2 (Blood on the Vine Tavern), M2 (Blue Water Inn) | ⬜ | Any inn set; reuse throughout |
| **Church interior** | M1 W2 (St. Andral's), M2 W1 | ⬜ | Pews, altar; any church set |
| **Forest/road** | M1 W3, M1 W4, M4 W1 | ⬜ | Trees, path; reuse many times |

---

### Priority 2 — Single Major Set-Pieces

| Terrain / Structure | Sessions Used | Own? | Notes |
|--------------------|--------------|------|-------|
| **Death House** (haunted manor, 3–5 floors) | M1 W1 | ⬜ | Full set or 2D printout; the most detailed dungeon of Act I |
| **Vallaki town square** | M2 W2 (festival), M2 W3 (coup), M4 W4 (war council) | ⬜ | Stocks, gallows, bonfire; town square tiles |
| **Old Bonegrinder** (windmill) | M2 W4 | ⬜ | A windmill structure; can improvise with cylinders |
| **Wizard of Wines Winery** | M3 W1 | ⬜ | Large farmhouse / winery interior; wine barrels |
| **Yester Hill** (stone circle on hilltop) | M3 W1 | ⬜ | Standing stones, elevated platform; hill terrain |
| **Wolf Den** (ravine exterior) | M3 W2 | ⬜ | Rocky ravine, cliff faces |
| **Argynvostholt** (ruined manor) | M3 W3 | ⬜ | Crumbling stone; reuse Death House tiles |
| **Amber Temple** (ziggurat interior) | M4 W2 | ⬜ | Amber-lit corridors; amber/gold cave tiles |
| **Ravenloft Dining Hall** | M3 W3 (dinner) | ⬜ | Long table, candelabras; noble interior |
| **Tser Pool camp** (Vistani tent camp) | M1 W3 | ⬜ | Wagons, fire pit, tents |

---

### Priority 3 — Useful but Improvise-able
...
|--------|----------|-----------|
| **Hero Forge** (heroforge.com) | Custom NPC minis (Ireena, Rahadin, party members) | $15–$30/mini |
| **WizKids D&D minis** | Pre-painted monsters (werewolves, vampire spawn, zombies) | $5–$15/mini |
| **Reaper Miniatures** | Unpainted; good NPC variety; often cheaper | $3–$12/mini |
| **MyMiniFactory / Printables** | 3D print files; huge Ravenloft selection | Free–$10/file |
| **Dwarven Forge** | Premium modular terrain; use for Castle Ravenloft | $$$; investment piece |
| **Fat Dragon Games** | Foam terrain kits; affordable | $40–$100/set |
| **2D printable maps** | Roll20, DriveThruRPG, Dungeon Fog | $5–$15; easiest option |
