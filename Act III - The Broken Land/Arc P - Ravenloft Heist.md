...
> > <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K15Chapel">K15. Chapel</a> (p. 57)</span>. “I’m sure it was beautiful once, but not anymore. I saw an armored corpse there once, but it was gone the next day. It might be worth taking a look around to see if anything is left."
...
> > <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K15Chapel">K15. Chapel</a> (p. 57)</span>. “Don’t forget to check the balcony overhead, just to make sure you’re not being watched."
...
This encounter begins as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/the-lands-of-barovia#VistaniBandits">Vistani Bandits</a> (p. 32)</span>. However, as the Vistani come into view, read:
...
> * <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K23ServantsEntrance">K23. Servants' Entrance</a> (p. 59)</span>, if the players are attempting to leave via that route,
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K3ServantsCourtyard">K3. Servants’ Courtyard</a> (p. 54)</span>.
...
***The Second Visit.*** The second time the players enter this area (e.g., after investigating the <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K10DiningHall">K10. Dining Hall</a> (p. 56)</span>, they find a thick carpet of fog has covered its entire floor. They also find Ludmilla Vilisevic standing at the center of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K8GreatEntry">K8. Great Entry</a> (p. 55)</span>, waiting for them.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K10DiningHall">K10. Dining Hall</a> (p. 56)</span>. However, there is no illusion of Strahd sitting at the organ. In addition, revise the area’s description to read as follows:
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K25AudienceHall">K25. Audience Hall</a> (p. 61)</span>. However, if Ludmilla has passed through here, the doors leading to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K27KingsHall">K27. King’s Hall</a> (p. 62)</span> are slightly ajar.
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K63WineCellar">K63. Wine Cellar</a> (p. 77)</span>.
### Kitchen
...
Anastrasya is also secretly joined by two additional **wights**, which conceal themselves in the secret passage between <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K42KingsBedchamber">K42. King’s Bedchamber</a> (p. 68)</span> and the western end of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K45HallofHeroes">K45. Hall of Heroes</a> (p. 68)</span>.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K45HallofHeroes">K45. Hall of Heroes</a> (p. 68)</span>. However, the statues are not imbued with the spirits of Strahd’s ancestors and cannot answer questions.

A secret door behind the furthest-west statue on the south side of the corridor leads to [[#King’s Bedchamber]], as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K42KingsBedchamber">K42. King’s Bedchamber</a> (p. 68)</span>. To open it, the statue’s sword arm must be pulled thirty degrees upward.
# P7. Bell Tower
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K38FalseTreasury">K38. False Treasury</a> (p. 66)</span>. However, a character that inspects the skeleton and succeeds on a DC 14 Wisdom (Medicine) check learns that it died of suffocation. In addition, a character that inspects the skeleton’s attire or equipment observes that its pockets are stuffed with gold coins.

> [!lore]+ **The Choking Skeleton**
> This dead adventurer entered Castle Ravenloft during Strahd’s hibernation, seeking to loot the castle for gold and jewels. After finding the secret door in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K27KingsHall">K27. King’s Hall</a> (p. 61)</span> and using it to access <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K31Trapworks">K31. Trapworks</a> (p. 63)</span>, he ascended the iron chains in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K31aElevatorShaft">K31a. Elevator Shaft</a> (p. 63)</span> and exited the secret door from <span class="citation"> <a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K31bShaftAccess">K31b. Shaft Access</a> (p. 64)</span> into <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K39HallofWebs">K39. Hall of Webs</a> (p. 67)</span>. 
>
> After entering the then-open secret door into <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K38FalseTreasury">K38. False Treasury</a> (p. 66)</span>, the adventurer took the torch from the wall nearby, causing the secret door to swing closed. He then opened the chest, failed to resist the effects of the sleeping gas, and became paralyzed. The fire in the fireplace in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K37Study">K37. Study</a> (p. 66)</span> then slowly consumed the rest of the oxygen in the chamber, eventually suffocating him.
...
The silhouette is the invisible stalker. If any character moves, speaks, or otherwise makes clear that they aren’t paralyzed, the invisible stalker flees back into the crack in the wall and enters <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K40Belfry">K40. Belfry</a> (p. 67)</span>. There, it rings the bell three times before returning to [[#P7d. Treasury]]. Read:
...
The sound of the bell attracts two **vampire spawn**, who pass from <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K53Rooftop">K53. Rooftop</a> (p. 71)</span> into <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>, then descend to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K45HallofHeroes">K45. Hall of Heroes</a> (p. 68)</span> before entering the false treasury via the secret door in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K37Study">K37. Study</a> (p. 66)</span>. The vampires attack the players on sight.
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K39HallofWebs">K39. Hall of Webs</a> (p. 67)</span>.
## P7c. Belfry
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K40Belfry">K40. Belfry</a> (p. 67)</span>. However, if the players drew the attention of the **invisible stalker** by activating the sleeping gas trap in [[#P7a. False Treasury]], a player with a passive Wisdom (Perception) score of 16 or higher notices that the dust and webbing around the secret door have recently been disturbed.
## P7d. Treasury
<span class="citation"><em>This scene takes place in Chapter 4, Area K41.</em></span>
### Entering the Tower
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K41Treasury">K41. Treasury</a> (p. 67)</span>. However, the command word to the *Daern’s instant fortress* is the same phrase as for the *Tome of Strahd*: “I come in Dostron’s memory."
...
Players who fail to open the door can still enter the tower through magical teleportation or by passing through the tower’s arrow slits through magical means, as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K41Treasury">K41. Treasury</a> (p. 67)</span>.
### Plundering the Treasury
The contents of the treasury are largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K41Treasury">K41. Treasury</a> (p. 67)</span>. However, replace the *alchemy jug*, *helm of brilliance*, and *rod of the pact keeper, +1* with a *driftglobe*, *cape of the mountebank*, two *pearls of power* and an *amber shard* of Great Taar Haak, the Five-Headed Destroyer. (See the [[Amber Shards]] appendix for more information about amber shards.). In addition, replace the four *potions of greater healing* with *potions of superior healing*, and add a *+1 light crossbow* hanging from a hook on the wall.
...
# P8. Guest Suite
This area of the castle once hosted important guests to the keep, including those described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#PidlwickII">Pidlwick II</a> (p. 236)</span>. In the castle’s heyday, access to the elevator shaft once allowed servants to bring hot meals and wine directly from the kitchens and wine cellar, providing prompt and efficient service.
## P8a. Guest Landing
<span class="citation"><em>This scene takes place in Chapter 4, Area K47.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K47PortraitofStrahd">K47. Portrait of Strahd</a> (p. 68)</span>. However, modify the portrait as follows:
...
On initiative count 20 of the second round of combat after the **guardian portrait** or **rug of smothering** attacks, a black **cat** emerges from <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K48Offstair">K48. Offstair</a> (p. 70)</span> and notices them. Read:
...
Shortly after combat ends, the door to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K49Lounge">K49. Lounge</a> (p. 70)</span> cracks open, and a pale, anxious-looking face peers out. (A player with a passive Wisdom (Perception) score of 14 or greater recognizes the face as Escher’s.) Upon noticing the players, Escher then immediately slams the door shut again.
## P8b. Guest Suite
<span class="citation"><em>This scene takes place in Chapter 4, Areas K49, 50 & 51.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K49Lounge">K49. Lounge</a> (p. 70)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K50GuestRoom">K50. Guest Room</a> (p. 70)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K51Closet">K51. Closet</a> (p. 70)</span>. However, modify this area’s description depending on Escher’s location, which is as follows:

* If he saw the players in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K47PortraitofStrahd">K47. Portrait of Strahd</a> (p. 68)</span> after they fought the **guardian portrait** and **rug of smothering** in [[#P8a. Guest Landing]], Escher attempts to conceal himself in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K51Closet">K51. Closet</a> (p. 70)</span> while waiting for the players to leave. 
* Otherwise, Escher is lounging on the couch as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K49Lounge">K49. Lounge</a> (p. 70)</span>.
...
If attacked, Escher attempts to flee through the window as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K49Lounge">K49. Lounge</a> (p. 70)</span>.
...
# P9. Coven’s Quarters
This area lies at the peak of Castle Ravenloft’s South Tower, once nicknamed the “General’s Tower" for the contents of its highest floor. Before Strahd became a vampire, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K54FamiliarRoom">K54. Familiar Room</a> (p. 71)</span> was a guard post responsible for manning and supplying <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K57TowerRoof">K57. Tower Roof</a> (p. 72)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K55ElementRoom">K55. Element Room</a> (p. 72)</span> was a map room and armory, and <span class="citation">K56. (p. Cauldron Room)</span> hosted the living quarters of General Kroval “Mad Dog" Grislek, whose remains now lie in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt38">Crypt 38</a> (p. 92)</span>.
## P9a. Familiar Room
<span class="citation"><em>This scene takes place in Chapter 4, Area K54.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K54FamiliarRoom">K54. Familiar Room</a> (p. 71)</span>. However, the door to this chamber is ajar, as is the door to the chamber beyond. 
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K55ElementRoom">K55. Element Room</a> (p. 72)</span>. However, a **zombie** stands silently at the center of the room. (The zombie doesn’t attack except in self-defense, or except as directed by the coven.) Add the following to the end of this area’s description:
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K56Cauldron">K56. Cauldron</a> (p. 72)</span>. However, replace the reference to “green-glowing wisps of steam" in this area’s description with “red-glowing wisps of steam."
...
If the players didn’t attract her to [[#Main Foyer]], Ludmilla Vilisevic is also present alongside the witches’ coven. (See [[#Main Foyer]] for her statistics.) If combat breaks out, Ludmilla prefers to lure any enemy combatants up <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K48Offstair">K48. Offstair</a> (p. 70)</span> toward <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K57TowerRoof">K57. Tower Roof</a> (p. 72)</span>, where she can more easily use the open-air battlefield to her advantage.
...
# P10. Garrison
This area of the castle once hosted the barracks and common areas of the castle guards, providing easy access to the upper-floor archers’ posts and battlements via <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K64GuardsStair">K64. Guards’ Stair</a> (p. 78)</span> and the North Tower Stair (<span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>). A quartet of secret doors, providing access to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K10DiningHall">K10. Dining Hall</a> (p. 56)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K25AudienceHall">K25. Audience Hall</a> (p. 61)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K33KingsApartmentStair">K33. King’s Apartment Stair</a> (p. 64)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K78BrazierRoom">K78. Brazier Room</a> (p. 82)</span>, also allowed for the castle’s protectors to swiftly and quietly navigate its floors or spirit away important targets to safety in the event of an attack.
## P10a. Garrison, Basement Floor
### Hall of Bones
<span class="citation"><em>This scene takes place in Chapter 4, Area K67.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K67HallofBones">K67. Hall of Bones</a> (p. 78)</span>. However, if Argynvost’s skull is removed from its mount, a **skeleton** crawls from each of the four mounds of bones at the corners of the room. The skeletons attack living creatures on sight.
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K68GuardsRun">K68. Guards’ Run</a> (p. 79)</span>.
### Guards’ Quarters
<span class="citation"><em>This scene takes place in Chapter 4, Area K69.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K69GuardsQuarters">K69. Guards’ Quarters</a> (p. 79)</span>. However, revise this area’s description as follows:
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K70KingsmenHall">K70. Kingsmen Hall</a> (p. 79)</span>.
### Kingsmen Quarters
<span class="citation"><em>This scene takes place in Chapter 4, Area K71.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K71KingsmenQuarters">K71. Kingsmen Quarters</a> (p. 79)</span>. However, the sack beneath the loose flagstone in the southeast alcove also contains a *stone of good luck*.
### Chamberlain’s Office
<span class="citation"><em>This scene takes place in Chapter 4, Area K72.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K72ChamberlainsOffice">K72. Chamberlain’s Office</a> (p. 79)</span>. However, remove Rahadin and the **shadow demon** from this room.
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K11SouthArchersPost">K11. South Archers’ Post</a> (p. 57)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K12TurretPost">K12. Turret Post</a> (p. 57)</span>. However, a single **shadow** dwells here, as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Shadows">Shadows</a> (p. 51)</span>.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20aTowerHallStair">K20a. Tower Hall Stair</a> (p. 59)</span>. Players who ascend the stairs reach [[#Servants’ Landing]].

> [!info]+ **The Heart of Sorrow**
> The Heart of Sorrow is largely as described in  <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>. However, it is immune to all damage, and no **vampire spawn** attack characters that attack it. In addition, rather than shaking the tower on initiative count 10 each round, the Heart shakes the tower each time the players attempt to ascend an additional story toward the Heart. 
>
...
This area is as described in <span class="citation">K13. Turrets Post Access Hall (p. 57)</span>. However, the entrance to this corridor contains a giant spider cocoon suspended from the ceiling, which is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#GiantSpiderCocoon">Giant Spider Cocoon</a> (p. 51)</span>. 

If opened, the cocoon contains Pidlwick II, who is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#PidlwickII">Pidlwick II</a> (p. 73)</span>. Pidlwick II is grateful to the characters for rescuing him, and attempts to assist them as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#PidlwickII">Pidlwick II</a> (p. 73)</span>. It otherwise acts as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#PidlwickII">Pidlwick II</a> (p. 73)</span>.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K22NorthArchersPost">K22. North Archers’ Post</a> (p. 59)</span>. 
## P10c. Garrison, Second Floor
### Second Floor South Archers’ Post Access Hall
<span class="citation"><em>This scene takes place in Chapter 4, Area K13.</em></span>

This area is largely as described in <span class="citation">K13. Turrets Post Access Hall (p. 57)</span>. However, four **crawling claws** cling to the ceiling above the secret door leading to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K25AudienceHall">K25. Audience Hall</a> (p. 61)</span>, and drop down to attack any creature that passes beneath them. The claws otherwise behave as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#CrawlingClaws">Crawling Claws</a> (p. 50)</span>.
### Second Floor South Archers’ Post
<span class="citation"><em>This scene takes place in Chapter 4, Areas K12 & K22.</em></span>

This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K12TurretPost">K12. Turret Post</a> (p. 57)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K22NorthArchersPost">K22. North Archers’ Post</a> (p. 59)</span>.
### Servants’ Landing
<span class="citation"><em>This scene takes place in Chapter 4, Area K20.</em></span>

This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>. Players who ascend the stairs reach [[#King’s Landing]]. Players who descend the stairs reach [[#North Tower Vestibule]].
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K22NorthArchersPost">K22. North Archers’ Post</a> (p. 59)</span>.
## P10d. Garrison, Third Floor
### Inner South Wall
<span class="citation"><em>This scene takes place in Chapter 4, Area K46.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K46Parapets">K46. Parapets</a> (p. 68)</span>.
...
>
> * ***Eastern Window.*** The window closest to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K64GuardsStair">K64. Guards’ Stair</a> (p. 78)</span> looks into [[#King’s Dining Hall]].
> * ***Western Windows.*** The two windows further from <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K64GuardsStair">K64. Guards’ Stair</a> (p. 78)</span> look into <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K44Closet">K44. Closet</a> (p. 68)</span> in [[#Bath Chamber & Closet]].
### Inner West Wall
<span class="citation"><em>This scene takes place in Chapter 4, Area K46.</em></span>
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>. Players who ascend the stairs reach [[#General’s Landing]] via [[#North Tower Stair]]. Players who descend the stairs reach [[#Servants’ Landing]].
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K20HeartofSorrow">K20. Heart of Sorrow</a> (p. 59)</span>. In addition, when the players arrive at this level, read:
...
This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K57TowerRoof">K57. Tower Roof</a> (p. 72)</span> and<span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K58Bridge">K58. Bridge</a> (p. 73)</span>.

> [!info]+ **Descending the Offstair**
> Players who descend <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K48Offstair">K48. Offstair</a> (p. 70)</span> exit the Garrison and enter [[Arc P - Ravenloft Heist#P9. Coven’s Quarters|Coven's Quarters]] via the landing outside [[#P9a. Familiar Room]].
## P10h. Garrison, Seventh Floor
### North Tower Peak
<span class="citation"><em>This scene takes place in Chapter 4, Areas K60.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K60NorthTowerPeak">K60. North Tower Peak</a> (p. 74)</span>. 
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K60aNorthTowerRooftop">K60a. North Tower Rooftop</a> (p. 74)</span>. However, revise this area’s description to read as follows:
...
> [!info]+ **Flooded Areas** 
> The areas of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K73DungeonHall">K73. Dungeon Hall</a> (p. 82) </span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74NorthDungeon">K74. North Dungeon</a> (p. 82) </span>, <span class="citation">K75. North Dungeon (p. 82) </span>, <span class="citation">and K76. Torture Chamber (p. 82) </span>  are difficult terrain.

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K73DungeonHall">K73. Dungeon Hall</a> (p. 79)</span>. However, the trapdoors function as follows:
...
* ***The First Trapdoor.*** The closest trapdoor to <span class="citation">K21. South Tower Stairs (p. 59)</span>, which ordinarily leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74cRottingCorpse">K74c. Rotting Corpse</a> (p. 80)</span>, instead teleports its victim to the **iron maiden** in [[#P11d. Torture Chamber]] (see below).
* ***The Second Trapdoor.*** The second-closest trapdoor to <span class="citation">K21. South Tower Stairs (p. 59)</span>, which ordinarily leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74aForgottenTreasure">K74a. Forgotten Treasure</a> (p. 80)</span>, instead teleports its victim to the **rack** in [[#P11d. Torture Chamber]] (see below).
* ***The Third Trapdoor.*** The third-closest trapdoor to <span class="citation">K21. South Tower Stairs (p. 59)</span>, which ordinarily leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74eEndoftheRide">K74e. End of the Ride</a> (p. 80)</span>, instead teleports its victim to the **brazen bull** in [[#P11d. Torture Chamber]] (see below).
* ***The Fourth Trapdoor.*** The fourth-closest trapdoor to <span class="citation">K21. South Tower Stairs (p. 59)</span>, which ordinarily leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74hLostSword">K74h. Lost Sword</a> (p. 81)</span>, instead teleports its victim to the **breaking wheel** in [[#P11d. Torture Chamber]] (see below).
* ***The Fifth Trapdoor.*** The furthest trapdoor from <span class="citation">K21. South Tower Stairs (p. 59)</span>, which ordinarily leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K75dDeadDwarf">K75d. Dead Dwarf</a> (p. 81)</span>, instead teleports its victim to the **scavenger’s daughter** in [[#P11d. Torture Chamber]] (see below).
## P11b. North Dungeon
<span class="citation"><em>This scene takes place in Chapter 4, Area K74.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74NorthDungeon">K74. North Dungeon</a> (p. 80)</span>. However, modify the half-elf corpse in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74cRottingCorpse">K74c. Rotting Corpse</a> (p. 80)</span> to be a human corpse instead.

In addition, modify the description of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K74hLostSword">K74h. Lost Sword</a> (p. 81)</span> to refer to a glowing mace, rather than a glowing blade. The mace has the same properties as the shortsword, but is not sentient, requires no attunement, and allows its wielder to cast *aura of life* rather than *crusader’s mantle*.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K75SouthDungeon">K75. South Dungeon</a> (p. 81)</span>. However, Emil doesn’t lie to players who tell him that Zuleika sent them, and is surprised, but grateful for their efforts to rescue him. No matter what, Emil doesn’t betray the players to Strahd or Strahd’s minions, and provides his best efforts to assist them in escaping the castle if rescued.
...
> If Milivoj was imprisoned in Castle Ravenloft in [[Arc D - St. Andral's Feast]], he is locked in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K75cEmptyCell">K75c. Empty Cell</a> (p. 81)</span>.
> 
## P11d. Torture Chamber
<span class="citation"><em>This scene takes place in Chapter 4, Areas K76 & K77.</em></span>

This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K76TortureChamber">K76. Torture Chamber</a> (p. 82)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K77ObservationBalcony">K77. Observation Balcony</a> (p. 82)</span>. However, remove the reference to the “last victims" of the torture devices in the water. In addition, replace the six **Strahd zombies** with three **zombies**, and add a three-foot amphora and an *alchemy jug* beside the thrones on the balcony. The amphora is filled with several gallons of oil, which is otherwise as described in <span class="citation">Oil (Flask) (Player’s Handbook, p. 152)</span>.
...
If the players failed to placate Volenta during [[Arc O - Dinner with the Devil#Volenta’s Toy|Arc O - Dinner with the Devil]], the corpse of Anton Konstantinovich has been turned into an additional **zombie** and is seated in the right-side throne of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K77ObservationBalcony">K77. Observation Balcony</a> (p. 82)</span>. If combat breaks out, or if any non-undead creatures approach within 5 feet of its throne, this **zombie** attacks and pursues the nearest living creatures within the area.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K78BrazierRoom">K78. Brazier Room</a> (p. 82)</span>. However, revise the brazier’s riddle to read as follows:
...
* Violet leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/the-ruins-of-berez#U5MarinasMonument">U5. Marina’s Monument</a> (p. 164)</span> in Berez.
* Orange leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/van-richtens-tower#V4TowerFirstFloor">V4. Tower, First Floor</a> (p. 170)</span> in Van Richten’s Tower.
* Red leads to the Shrine of the White Sun in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/the-village-of-krezk#S4PoolandShrine">S4. Pool and Shrine</a> (p. 146)</span> in Krezk.
* Green leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/the-town-of-vallaki#N6fVampireNest">N6f. Vampire Nest</a> (p. 118)</span> in the Coffin Maker’s Shop in Vallaki.
* Indigo leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/the-village-of-barovia#E6Cemetery">E6. Cemetery</a> (p. 48)</span> in the Village of Barovia.
* Blue leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/the-wizard-of-wines#W6Well">W6. Well</a> (p. 176)</span> near the Wizard of Wines.
* Yellow leads to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/tsolenka-pass#T4GuardTowerGroundFloor">T4. Guard Tower, Ground Floor</a> (p. 157)</span> in the guard tower at Tsolenka Pass.
...
* A player who investigates <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K79WesternStair">K79. Western Stair</a> (p. 84)</span> (leading to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K72ChamberlainsOffice">K72. Chamberlain’s Office</a> (p. 79)</span>) observes a humanoid silhouette appearing to observe them from the far side of the landing. Once noticed, the silhouette quickly ducks out of sight. (The silhouette is a **shadow**. See [[#P11f. Western Stair]] for more information about the shadow if the players attempt to confront or communicate with it.)
* A player who investigates <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K80CenterStair">K80. Center Stair</a> (p. 84)</span> (leading to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K81Tunnel">K81. Tunnel</a> (p. 84)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K84Catacombs">K84. Catacombs</a> (p. 85)</span>) observes only the thick, opaque fog, which limits visibility as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K81Tunnel">K81. Tunnel</a> (p. 84)</span>.
* A player who investigates <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K83SpiralStair">K83. Spiral Stair</a> (p. 85)</span> (leading to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K37Study">K37. Study</a> (p. 66)</span>) observes a woman’s slipper lying discarded on one of the upper stairs, just before the spiral staircase curves out of sight. A DC 12 Intelligence (Investigation) check suggests that the slipper’s owner was traveling up the staircase, rather than down. (The slipper is Gertruda’s, and was left here by Strahd to lure the players toward her bedchamber.)
* A player who investigates the door leading toward <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K77ObservationBalcony">K77. Observation Balcony</a> (p. 82)</span> finds a pale, white mask hanging from the handle. Players who previously encountered Anton Konstantinovich in [[Arc O - Dinner with the Devil#Volenta’s Toy|Arc O - Dinner with the Devil]] recognize the mask as his.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K79WesternStair">K79. Western Stair</a> (p. 84)</span>. However, remove the *glyph of warding*. Instead, a curious, yet fearful **shadow** lurks here.

If the players approach the staircase from <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K78BrazierRoom">K78. Brazier Room</a> (p. 82)</span>, the shadow flees upward, squeezing through the secret door to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K72ChamberlainsOffice">K72. Chamberlain’s Office</a> (p. 79)</span> and concealing itself within one of the drawers of Rahadin’s desk. (The shadow isn’t very good at hiding, allowing part of its ephemeral, shroud-like body to extrude through the drawer’s keyhole.)

If the players enter the staircase via the secret door in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K72ChamberlainsOffice">K72. Chamberlain’s Office</a> (p. 79)</span>, the shadow flees downward, concealing itself behind the western **iron golem** in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K78BrazierRoom">K78. Brazier Room</a> (p. 82)</span>. While the players remain in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K78BrazierRoom">K78. Brazier Room</a> (p. 82)</span>, the shadow amuses itself by pretending to be a player’s shadow. A player with a passive Wisdom (Perception) score of 14 or greater notices that the chosen player has an extra shadow.
...
> If the players reunite this shadow with its friend from [[#First Floor South Archers’ Post]], the shadows swirl happily around one another in greeting. As a show of thanks, the shadows then attempt to lead the players to the loose flagstone in the southeast alcove of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K71KingsmenQuarters">K71. Kingsmen Quarters</a> (p. 79)</span>, then disappear together into a nearby crack in the wall.

> [!info]+ **Ascending the Stair**
> A player who departs the western stair via the secret door to <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K72ChamberlainsOffice">K72. Chamberlain’s Office</a> (p. 79)</span> exits the dungeons and enters [[#P10. Garrison]] via [[#Chamberlain’s Office]].
## P11g. Catacomb Tunnel
<span class="citation"><em>This scene takes place in Chapter 4, Areas K81 & K82.</em></span>

This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K81Tunnel">K81. Tunnel</a> (p. 84)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K82MarbleSlide">K82. Marble Slide</a> (p. 85)</span>.
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K84Catacombs">K84. Catacombs</a> (p. 85)</span>, except where denoted otherwise below.
...
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt1">Crypt 1</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt2">Crypt 2</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt3">Crypt 3</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt4">Crypt 4</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt5">Crypt 5</a> (p. 86)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt6">Crypt 6</a> (p. 86)</span>. However, replace the epigraph and contents of Crypt 6 with the epigraph and contents of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt40">Crypt 40</a> (p. 93)</span>, and remove the trap surrounding Crypt 6.

Players who exit <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K81Tunnel">K81. Tunnel</a> (p. 84)</span> via Crypt 1, or who approach the intersection between Crypts 2, 7, and 8 observe a human corpse lying on the stone floor just south of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt2">Crypt 2</a> (p. 87)</span>. (The corpse is a **zombie. See below for more information.**)
#### North Crypts, Second Row
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt7">Crypt 7</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt8">Crypt 8</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt9">Crypt 9</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt10">Crypt 10</a> (p. 87)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt11">Crypt 11</a> (p. 87)</span>. However, Tasha Petrovna’s holy symbol in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt11">Crypt 11</a> (p. 87)</span> is not present; instead, it is currently worn by Father Lucian in Vallaki.

In addition, a human corpse lies sprawled across the floor immediately south of <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt2">Crypt 2</a> (p. 87)</span>. If approached, the corpse rises as a **zombie** and attacks.
...
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt12">Crypt 12</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt13">Crypt 13</a> (p. 88)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt14">Crypt 14</a> (p. 88)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt15">Crypt 15</a> (p. 88)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt16">Crypt 16</a> (p. 89)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt17">Crypt 17</a> (p. 89)</span>. However, replace the epigraph on Crypt 16 to read “Elsa Fallona, Beloved Actor."
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K85SergeisTomb">K85. Sergei’s Tomb</a> (p. 93)</span>. However, Sergei’s armor is nonmagical and ceremonial, rather than practical, and cannot be used as plate armor.
## P12b. Central Catacombs
### Central Crypts
#### Central Crypts, North Row
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt18">Crypt 18</a> (p. 89)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt19">Crypt 19</a> (p. 89)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt20">Crypt 20</a> (p. 89)</span>. However, Sasha does not attack the players if encountered in her crypt. (Strahd has ordered her to remain here, and she cannot depart her crypt if asked.)
#### Central Crypts, South Row
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt21">Crypt 21</a> (p. 89)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt22">Crypt 22</a> (p. 90)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt23">Crypt 23</a> (p. 90)</span>. However, Crypt 21 does not contain Patrina’s **banshee**. (Patrina’s spirit instead resides in the Amber Temple.) In addition, the epigraph on Crypt 23 bears the name of the character whose skill, arrogance, and power have impressed Strahd the most.
### King & Queen’s Tomb
<span class="citation"><em>This scene takes place in Chapter 4, Areas K87 & K88.</em></span>

This area is as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K87Guardians">K87. Guardians</a> (p. 94)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K88TombofKingBarovandQueenRavenovia">K88. Tomb of King Barov and Queen Ravenovia</a> (p. 94)</span>.
## P12c. South Catacombs
### South Crypts
#### South Crypts, First Row
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt24">Crypt 24</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt25">Crypt 25</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt26">Crypt 26</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt27">Crypt 27</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt28">Crypt 28</a> (p. 90)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt29">Crypt 29</a> (p. 91)</span>. However, remove the **giant wolf spiders** from Crypt 27, and replace the *luck blade* in Crypt 29 with a set of *+2 studded leather armor*.
#### South Crypts, Second Row
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt30">Crypt 30</a> (p. 91)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt31">Crypt 31</a> (p. 91)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt32">Crypt 32</a> (p. 91)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt33">Crypt 33</a> (p. 91)</span> and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt34">Crypt 34</a> (p. 92)</span>. However, revise the epigraph on Crypt 33 to read “St. Finderway, Saint of Lost Travelers," and replace Sir Klutz’s remains with a set of human bones lying beside an *orb of direction* (<span class="citation">Xanathar’s Guide to Everything, p. 138</span>) hanging from a leather cord.
...
> This six-foot shaft of ash wood is adorned with carvings of wild animals, vines, and leaves, and bears a simple, yet sharp stone head. When first recovered from Dostron’s sarcophagus, it has the properties of a *blood spear* (<span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/appendix-c-treasures#BloodSpear">Blood Spear</a>, p. 221</span>), but its wielder gains only a +1 bonus to attack and damage rolls made with it instead of +2. (The spear was corrupted long ago by the influence of Kavan and the Devourer, and can be restored only by reconsecrating the Forest Fane at Yester Hill, which the players can learn about at the Mountain Folk settlement of Soldav on Mount Ghakis.)
#### South Crypts, Third Row
This row of crypts is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt35">Crypt 35</a> (p. 92)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt36">Crypt 36</a> (p. 92)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt37">Crypt 37</a> (p. 92)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt38">Crypt 38</a> (p. 92)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt39">Crypt 39</a> (p. 93)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt40">Crypt 40</a> (p. 93)</span>. However, the **hell hounds** and General Grislek’s **wraith** do not emerge from Crypt 38 when it is first opened. In addition, Beucephalus cannot be found in Crypt 39 at this time. Finally, move the invisible teleport traps described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#TeleportTraps">Teleport Traps</a> (p. 85)</span> to the base of the stairs in Strahd’s tomb (see below).
...
>
> * The wielder gains the lair actions described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/appendix-d-monsters-and-npcs#LairActions">Lair Actions</a> (p. 239)</span>, and gains the ability to pass through solid walls, doors, ceilings, and floors as if they weren’t there.
> * Every crypt door in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K84Catacombs">K84. Catacombs</a> (p. 85)</span> swings open.
> * The **skeletons** in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt2">Crypt 2</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt3">Crypt 3</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt5">Crypt 5</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt2">Crypt 2</a> (p. 86)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt8">Crypt 8</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt9">Crypt 9</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt10">Crypt 10</a> (p. 87)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt13">Crypt 13</a> (p. 88)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt16">Crypt 16</a> (p. 89)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt17">Crypt 17</a> (p. 89)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt19">Crypt 19</a> (p. 89)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt24">Crypt 24</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt25">Crypt 25</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt26">Crypt 26</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt28">Crypt 28</a> (p. 90)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt30">Crypt 30</a> (p. 91)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt33">Crypt 33</a> (p. 91)</span>, <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt36">Crypt 36</a> (p. 92)</span>, and <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt37">Crypt 37</a> (p. 92)</span> animate. The following round, each skeleton emerges from its crypt, pursuing and attacking any intruders on sight. (Skeletons without weapons can make only unarmed strikes and grapples.)
> * All one hundred **skeletons** in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt14">Crypt 14</a> (p. 88)</span> animate. Over the following three rounds, the skeletons form a living ladder, allowing any remaining **wights** in the vault to climb from the shaft and emerge from the crypt, pursuing and attacking any intruders on sight. 2d6 armed **skeletons** emerge from the crypt each subsequent round, until all skeletons have emerged.
> * On initiative count 20 of the third round after the amulet is activated, the **hell hounds** and **wraith** described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt38">Crypt 38</a> (p. 92)</span> begin to manifest in their crypt, coalescing fully from brimstone smoke three rounds later. They then emerge to pursue any intruders still remaining in the catacombs or [[#P11g. Catacomb Tunnel]].
> * The **iron golems** in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K78BrazierRoom">K78. Brazier Room</a> (p. 82)</span> begin to animate, activating fully on initiative count 20 of the fifteenth round after the amulet is activated. (Creatures in the Brazier Room while the golems are activating can observe their limbs and heads slowly grinding to life, their lifeless gazes locking onto any intruders present in their chamber.)
...
This area is largely as described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#K86StrahdsTomb">K86. Strahd’s Tomb</a> (p. 93)</span>. However, the teleport traps described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#TeleportTraps">Teleport Traps</a> (p. 85)</span> form a protective ring around the base of the staircase that descends into the tomb, rather than around the entrance to the tomb. In addition, replace the three vampiric brides buried in the earth near the east wall with three anonymous **vampire spawn** created from ordinary Barovians. 
  
> [!combat]- **Balancing the Tomb of the Darklord** 
> This combat encounter is a **mild** combat encounter against a party of five 7th-level players, a CR 2 ally (Ireena Kolyana), and a CR 4 ally (Ezmerelda d’Avenir), and will consume approximately 16% of their total maximum hit points. For parties of smaller or larger sizes, modify the encounter as follows: 
> * **Three Players**. Reduce the number of vampire spawn to 2.

Strahd’s coffin is surrounded by a 5-foot-radius *antimagic field* effect identical to the one described in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/van-richtens-tower#KhazansSpellDrain">Khazan’s Spell Drain</a> (p. 167)</span>. The effect doesn’t apply to spells cast by a creature attuned to *Khazan's Staff*, which is hidden in <span class="citation"><a href="https://www.dndbeyond.com/sources/dnd/cos/castle-ravenloft#Crypt15">Crypt 15</a> (p. 88)</span> in [[#North Crypts, Third Row]].